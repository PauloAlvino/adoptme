...
router.post('/create', protectedRoutes, imageUpload.array('images'), PetController.createPet)
...
router.get('/:id', protectedRoutes, PetController.getPet)
router.delete('/:id', protectedRoutes, PetController.deletePet)
router.patch('/:id', protectedRoutes, imageUpload.array('images'), PetController.updatePet)
